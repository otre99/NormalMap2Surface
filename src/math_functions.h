...
void OPTIteration(const cv::Mat &dZ, const cv::Mat &invalid_pixels,
                  const cv::Mat &src, cv::Mat &dst);

void GetRotateProblem(const cv::Mat &nm, const cv::Mat &invalid,
                      const double angle, cv::Mat &nm_rotated,
