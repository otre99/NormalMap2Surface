...
void ColorMapper::loadPreset(GradientPreset preset) {
  ...
  case gpYellow:
    setColorInterpolation(ciHSV);
    setColorStopAt(0, QColor(Qt::yellow).lighter());
    setColorStopAt(1, QColor(Qt::yellow).darker());
    break;
  case gpBlue:
    setColorInterpolation(ciHSV);
    setColorStopAt(0, QColor(Qt::white));
    setColorStopAt(0.25, QColor(Qt::blue).lighter());
    setColorStopAt(0.50, QColor(Qt::blue));
    setColorStopAt(1.0, QColor(Qt::blue).darker());
    break;
  }
  mPreset = preset;
}
